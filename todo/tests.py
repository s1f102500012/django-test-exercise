...
class TodoViewTestCase(TestCase):
    ...
    def test_index_get_order_post(self):
        task1 = Task(
            title='task1',
            posted_at=timezone.make_aware(datetime(2024, 6, 1)),
            due_at=timezone.make_aware(datetime(2024, 7, 1)),
        )
        task1.save()
        task2 = Task(
            title='task2',
            posted_at=timezone.make_aware(datetime(2024, 6, 2)),
    ...
    def test_update_post_success(self):
        ...
        self.assertEqual(
            task.due_at, timezone.make_aware(datetime(2024, 8, 1, 12, 0, 0))
        )
